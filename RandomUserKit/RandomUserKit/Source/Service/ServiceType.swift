...
/// A type that knows how to perform requests for Random user data from http://randomuser.me/ API.
...
public protocol ServiceType {
    ...
    func fetchUsers(results: Int?, completion: @escaping (Result<[User], Error>) -> Void)
}
